...
### I BUILD THINGS.
**Algorithms. AI. Systems. Products. Experiences.**

I am an IT Engineering student building complex, experimental, and interactive systems. I focus on turning ideas from raw concepts into finished products—optimizing data structures, training agent loops, and designing telemetry interfaces.
...
*   **LANGUAGES:** C &bull; Java &bull; Python &bull; JavaScript &bull; TypeScript &bull; Rust &bull; Kotlin
*   **BUILD:** React &bull; React Native &bull; Node.js &bull; Vite &bull; Expo &bull; Tauri
*   **DATA:** PostgreSQL &bull; Supabase &bull; SQLite
*   **TOOLS:** Git &bull; Linux &bull; Docker &bull; Vercel &bull; Android Studio
...
```text
→ Optimizing pathfinding heuristics (Dijkstra/A* weight matrices)
→ Deferring offline state pipelines for Gemini mobile wrappers
→ Designing custom rust telemetry canvas shaders
→ Transforming experimental concepts into production assets
```
